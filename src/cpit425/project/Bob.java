/*
 * Names: Manar Altaiary - Elaf Aloufi
 * ID: 1906775 - 1911265
 * CPIT425 Project 
 */
...
public class Bob {
    ...
    public String DecryprtionMessage(Alice a, byte[] key,String Dcrypted2) throws InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
        ...
        dcrypted = cipher.doFinal(Base64.getDecoder().decode(Dcrypted2.getBytes()));
